...
public sealed partial class MainWindow : Window
{
    ...
    private void ApplyTheme(string themeName)
    {
        ...
        SetAppBrush("AppAccentBrush", preset.Accent);
        SetAppBrush("AppAccentTextBrush", preset.Accent);
        SetAppBrush("AppCardBackgroundBrush", preset.Dark ? "#171A1F" : "#F8F7F2");
        SetAppBrush("AppCardStrokeBrush", preset.Dark ? "#334155" : "#3364748B");
        SetAppBrush("AppSubtleFillBrush", preset.Dark ? "#2864748B" : "#1464748B");
        SetAppBrush("AppPrimaryTextBrush", preset.Dark ? "#F8FAFC" : "#111827");
        ThemeNameText.Text = preset.DisplayName;
    }

    private static void SetAppBrush(string key, string color)
    {
